...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AssociationAPI.Models.DbModels.ClientProvider", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int>("ElectricityFk");

                    b.Property<int>("GasFk");

                    b.Property<int>("WaterFk");

                    b.HasKey("Id");

                    b.HasIndex("ClientId");

                    b.HasIndex("ElectricityFk");

                    b.HasIndex("GasFk");

                    b.HasIndex("WaterFk");

                    b.ToTable("ClientProviders");
                });
            ...
            modelBuilder.Entity("AssociationAPI.Models.DbModels.Provider", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("AssociationAPI.Models.DbModels.ClientProvider", b =>
                {
                    b.HasOne("AssociationAPI.Models.DbModels.User", "Client")
                        .WithMany("ClientProvider")
                        .HasForeignKey("ClientId");

                    b.HasOne("AssociationAPI.Models.DbModels.Provider", "ElectricityProvider")
                        .WithMany("ElectricityProvider")
                        .HasForeignKey("ElectricityFk")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("AssociationAPI.Models.DbModels.Provider", "GasProvider")
                        .WithMany("GasProvider")
                        .HasForeignKey("GasFk")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("AssociationAPI.Models.DbModels.Provider", "WaterProvider")
                        .WithMany("WaterProvider")
