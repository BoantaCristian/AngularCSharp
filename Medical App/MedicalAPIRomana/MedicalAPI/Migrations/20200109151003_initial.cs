        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PillPerDay = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IllnessSymptomes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_IllnessSymptomes_Illnesses_IllnessId",
                        column: x => x.IllnessId,
                        principalTable: "Illnesses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_IllnessSymptomes_Symptoms_SymptomId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Histories_Illnesses_IllnessId",
                        column: x => x.IllnessId,
                        principalTable: "Illnesses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IllnessSymptomes_IllnessId",
                table: "IllnessSymptomes",
                column: "IllnessId");

            migrationBuilder.CreateIndex(
                name: "IX_IllnessSymptomes_SymptomId",
                table: "IllnessSymptomes",
                column: "SymptomId");
